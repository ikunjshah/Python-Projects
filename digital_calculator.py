...
class Application(Frame):
    ...
    def create_widgets(self):
        self.user_input = Entry(self, bg = '#5BC8AC' ,bd=29, insertborderwidth=4, width=24,
        ...
        self.button2 = Button(self, bg='#98DBC6', bd=12, text='8', padx=35, pady=25, font=('Helvetica', 20, 'bold'),
        ...
        self.button5 = Button(self, bg='#98DBC6', bd=12, text='5', padx=35, pady=25, font=('Helvetica', 20, 'bold'),
        ...
        self.button8 = Button(self, bg='#98DBC6', bd=12, text='2', padx=35, pady=25, font=('Helvetica', 20, 'bold'),
        ...
        self.button10 = Button(self, bg='#98DBC6', bd=12, text='0', padx=33, pady=25, font=('Helvetica', 20, 'bold'),
        command=lambda : self.buttonClick(0))
        self.button10.grid(row=5, column =0, sticky=W)

        self.Addbutton = Button(self, bg='#98DBC6', bd=12, text='+', padx=36, pady=25, font=('Helvetica', 20, 'bold'),
        command=lambda : self.buttonClick('+'))
        self.Addbutton.grid(row=2, column =3, sticky=W)

        self.Subbutton = Button(self, bg='#98DBC6', bd=12, text='-', padx=39, pady=25, font=('Helvetica', 20, 'bold'),
        command=lambda : self.buttonClick('-'))
        self.Subbutton.grid(row=3, column =3, sticky=W)

        self.Multbutton = Button(self, bg='#98DBC6', bd=12, text='X', padx=38, pady=25, font=('Helvetica', 20, 'bold'),
        command=lambda : self.buttonClick('*'))
        self.Multbutton.grid(row=4, column =3, sticky=W)

        self.Divtbutton = Button(self, bg='#98DBC6', bd=12, text='/', padx=39, pady=25, font=('Helvetica', 20, 'bold'),
        command=lambda : self.buttonClick('/'))
        self.Divbutton.grid(row=5, column =3, sticky=W)

        self.Equalbutton = Button(self, bg='#E6D72A', bd=12, text='=', padx=100, pady=25, font=('Helvetica', 20, 'bold'),
        command=lambda : self.buttonClick('='))
        self.Equalbutton.grid(row=5, column =3, sticky=W, columnspan=2)

        self.Clearbutton = Button(self, bg='#E6D72A', bd=12, text='AC', font=('Helvetica', 20, 'bold'),
        width=28, padx=7, command=self.ClearDisplay)
    ...
    def CalculateTask(self):
        ...
        try:
            ...
            self.diplayText('Invalid Syntax!')
            self.task = ''
